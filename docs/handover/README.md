...
| 4 — History UI | `cursor/snooze-store-phase4-1018` | Done | [phase-4-checklist.md](./phase-4-checklist.md) |
| 5 — Cleanup | `cursor/snooze-store-phase5-1018` | Done | [phase-5-checklist.md](./phase-5-checklist.md) |
